...
NPArray_2_DD_int64 = np.ndarray[tuple[int, ...], np.dtype[np.int64]]
NPArray_2_D2_int64 = np.ndarray[tuple[int, Literal[2]], np.dtype[np.int64]]
NPArray_2_D3_int64 = np.ndarray[tuple[int, Literal[3]], np.dtype[np.int64]]

NPArray_1_D_uint64 = np.ndarray[tuple[int, ...], np.dtype[np.uint64]]
NPArray_2_DD_uint64 = np.ndarray[tuple[int, ...], np.dtype[np.uint64]]
...
NPArray_2_DD_float64 = np.ndarray[tuple[int, ...], np.dtype[np.float64]]
NPArray_2_D2_float64 = np.ndarray[tuple[int, Literal[2]], np.dtype[np.float64]]
NPArray_2_D3_float64 = np.ndarray[tuple[int, Literal[3]], np.dtype[np.float64]]