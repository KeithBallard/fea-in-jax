"""Smoke test for the direct-only PETSc Mat function wrapper.

Run:

    /home/alberto/venvs/mpi-gpu/bin/python tests/v10/test_snes_direct_only_mat_func.py
"""
...
def main():
    ...
    try:
        print("Testing direct-only JAX matrix function -> PETSc Mat callback.")
        callback_func = convertJAXMatFuncToPETScMatFuncDirect(jac_func)
